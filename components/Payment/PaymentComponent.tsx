...
export default function PaymentComponent() {
  ...
  return (
    ...
    >
      <View>
        <Text
          className="text-3xl self-center mt-10 text-green"
          style={{ fontFamily: 'Poppins-Medium' }}
        >
          Payment
        </Text>
        <Text
          className="text-4xl mt-5 font-medium 
        ...
        <Text
          className="text-base mb-2 font-base text-gray self-center"
          style={{ fontFamily: 'Poppins-Medium' }}
        >
      ...
      <View>
        <CustomPressable text="Confirm Payment" onPress={showModal} />
      </View>
