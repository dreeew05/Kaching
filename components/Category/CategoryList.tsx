...
function clickable(category: CategoryProps) {
  return (
    <View className="w-1/2" key={category.id}>
      <CategoryCardClickable id={category.id} name={category.name} image={category.image} />
    </View>
  );
}
...
function editable(category: CategoryProps) {
  return (
    <View className="w-1/2" key={category.id}>
      <CategoryCardEditable id={category.id} name={category.name} image={category.image} />
    </View>
  );
}
